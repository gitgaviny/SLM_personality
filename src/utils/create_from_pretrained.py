...
def parse_args() -> argparse.Namespace:  # noqa: D401
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.1,
        help="Loss weight for ASR task",
    )
    parser.add_argument(
        "--emotion_loss_weight",
        type=float,
        default=1.0,
        help="Loss weight for emotion task",
    )
...
def main() -> None:  # noqa: D401
    ...
    save_dir = args.save_dir or f"hubert-{args.llm_id}"
    save_path = ensure_path(save_dir)

    logging.info("Encoder: %s", args.encoder_base)
    ...
    model.config.asr_loss_weight = args.asr_loss_weight
    model.config.emotion_loss_weight = args.emotion_loss_weight
    ...
    # ------------------------------------------------------------------
    feature_extractor = AutoFeatureExtractor.from_pretrained(args.encoder_base)
