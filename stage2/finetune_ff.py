...
def main():
    ...
    train_split_name = getattr(data_args, "train_split_name", "train")
    eval_split_name = getattr(data_args, "eval_split_name", None)
    trainer = Seq2SeqTrainer(
        model=model,
        args=training_args,
        train_dataset=vectorized_datasets[train_split_name] if training_args.do_train else None,
        eval_dataset=vectorized_datasets[eval_split_name] if training_args.do_eval else None,
